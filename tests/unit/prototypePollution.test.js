...
describe('Prototype Pollution Protection', () => {
  ...
  describe('mergeConfig', () => {
    ...
    it('should not inherit transport from Object.prototype', () => {
    ...
    it('should not inherit transformRequest from Object.prototype', () => {
    ...
    it('should not inherit transformResponse from Object.prototype', () => {
    ...
    it('should not inherit arbitrary keys from Object.prototype', () => {
  ...
  describe('GHSA-q8qp-cvcw-x6jj http adapter gadgets', () => {
    ...
    it('should not pick up Object.prototype.socketPath', async () => {
